...
protected:
  void SetUp() override
  {
    ...
    rcutils_ret_t ret = rcutils_hash_map_init(
      &map, 2, sizeof(uint32_t), sizeof(uint32_t), test_hash_map_uint32_hash_func, test_uint32_cmp,
      &allocator);
...
{
  rcutils_ret_t ret = rcutils_hash_map_init(
    NULL, 2, sizeof(uint32_t), sizeof(uint32_t), test_hash_map_uint32_hash_func, test_uint32_cmp,
    &allocator);
...
{
  rcutils_ret_t ret = rcutils_hash_map_init(
    &map, 0, sizeof(uint32_t), sizeof(uint32_t), test_hash_map_uint32_hash_func, test_uint32_cmp,
    &allocator);
  EXPECT_EQ(RCUTILS_RET_INVALID_ARGUMENT, ret) << rcutils_get_error_string().str;
}
...
{
  rcutils_ret_t ret = rcutils_hash_map_init(
    &map, 3, sizeof(uint32_t), sizeof(uint32_t), test_hash_map_uint32_hash_func, test_uint32_cmp,
    &allocator);
...
{
  rcutils_ret_t ret = rcutils_hash_map_init(
    &map, 2, 0, sizeof(uint32_t), test_hash_map_uint32_hash_func, test_uint32_cmp, &allocator);
  EXPECT_EQ(RCUTILS_RET_INVALID_ARGUMENT, ret) << rcutils_get_error_string().str;
}
...
{
  rcutils_ret_t ret = rcutils_hash_map_init(
    &map, 2, sizeof(uint32_t), 0, test_hash_map_uint32_hash_func, test_uint32_cmp, &allocator);
  EXPECT_EQ(RCUTILS_RET_INVALID_ARGUMENT, ret) << rcutils_get_error_string().str;
}
...
{
  rcutils_ret_t ret = rcutils_hash_map_init(
    &map, 2, sizeof(uint32_t), sizeof(uint32_t), NULL, test_uint32_cmp, &allocator);
  EXPECT_EQ(RCUTILS_RET_INVALID_ARGUMENT, ret) << rcutils_get_error_string().str;
}
...
{
  rcutils_ret_t ret = rcutils_hash_map_init(
    &map, 2, sizeof(uint32_t), sizeof(uint32_t), test_hash_map_uint32_hash_func, NULL, &allocator);
  EXPECT_EQ(RCUTILS_RET_INVALID_ARGUMENT, ret) << rcutils_get_error_string().str;
}
...
TEST_F(HashMapBaseTest, string_keys)
{
  ...
  rcutils_ret_t ret = rcutils_hash_map_init(
    &map, 8, sizeof(char *), sizeof(uint32_t), rcutils_hash_map_string_hash_func,
    rcutils_hash_map_string_cmp_func, &allocator);
  EXPECT_EQ(RCUTILS_RET_OK, ret) << rcutils_get_error_string().str;
